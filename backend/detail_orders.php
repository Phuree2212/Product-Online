    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <table align="center" class="table table-striped">
                ...
                <form action="approves_orders.php" method="post" enctype="multipart/form-data">
                <table>
                        <tr height="45">
                        ...
                        <tr height="55">
                            <td width="100" align="right">หลักฐานชำระเงิน&nbsp;</td>
                            <?php 
                            ...
                            <td width="500"><a href="../img/Payment/<?php echo $proof_payment ?>" target="_blank"><img width="180" height="280" src="../img/Payment/<?php echo $proof_payment ?>"></a></td>
                            
                            <?php }else{ ?>

                                <td width="500"><input name="payment" class="form-control border border-dark" value="ยังไม่ได้ดำเนินการชำระเงิน"></td>
                ...
                <div class="mb-2 mt-2 text-center">
                    <?php if($order_status == 'รอดำเนินการชำระเงิน'){ ?>
                    <input type="submit" value="อนุมัติคำสั่งซื้อ" name="submit" class="btn btn-success" disabled>
                    <?php }elseif($order_status == "รอดำเนินการตรวจสอบ"){ ?>
                    <input type="submit" value="อนุมัติคำสั่งซื้อ" name="submit" class="btn btn-success">
                    <a href="not_approved_orders.php?orderid=<?php echo $order_id; ?>&quantity=<?php echo $quantity ?>" class="btn btn-danger">ไม่อนุมัติคำสั่งซื้อ</a>
                    <?php }elseif($order_status == "ยกเลิก" or $order_status == "ลูกค้ารับสินค้าแล้ว"){ ?>
                    <?php }else{ ?>
                    <a href="success_orders.php?orderid=<?php echo $order_id ?>" class="btn btn-success">ลูกค้ารับสินค้าแล้ว</a>
                    <?php } ?>
                </div>
                </form>
