...
<body>
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="d-flex align-items-center mb-3 mt-3 justify-content-center"><h2 class="me-2">ประวัติการสั่งซื้อ</h2><i class="fa-solid fa-file-invoice fa-3x" style="color:cornflowerblue"></i></div>
